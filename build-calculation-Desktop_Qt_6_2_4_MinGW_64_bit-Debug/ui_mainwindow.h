...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(513, 587);
        MainWindow->setMinimumSize(QSize(513, 552));
...
" border-color: #BEBEBE;"));
        ...
        strochka->setStyleSheet(QString::fromUtf8(""));
...
""));
        ...
        pushButton_cred->setGeometry(QRect(130, 520, 261, 24));
